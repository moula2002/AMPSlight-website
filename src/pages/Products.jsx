...
const getIcon = (iconName) => {
  switch (iconName) {
    case 'Box': return <Box className="w-10 h-10 text-gold mb-6" />;
    case 'Factory': return <Factory className="w-10 h-10 text-gold mb-6" />;
    case 'Home': return <Home className="w-10 h-10 text-gold mb-6" />;
    case 'Cpu': return <Cpu className="w-10 h-10 text-gold mb-6" />;
    default: return <Box className="w-10 h-10 text-gold mb-6" />;
  }
};
